...
bool ARTracker2d::update(AR2VideoBufferT *buff, std::vector<ARTrackable *>& trackables, bool doDatums)
{
...
bool ARTracker2d::update(AR2VideoBufferT *buff0, AR2VideoBufferT *buff1, std::vector<ARTrackable *>& trackables, bool doDatums)
{
