...
public:
    ...
    bool update(AR2VideoBufferT *buff, std::vector<ARTrackable *>& trackables, int markerType = -1) override;
    bool update(AR2VideoBufferT *buff0, AR2VideoBufferT *buff1, std::vector<ARTrackable *>& trackables, int markerType = -1) override;
    bool stop() override;
