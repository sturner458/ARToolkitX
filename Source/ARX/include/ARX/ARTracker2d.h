...
public:
    ...
    bool update(AR2VideoBufferT *buff, std::vector<ARTrackable *>& trackables, bool lowRes, bool doDatums = false, bool doMapper = false, int markerType = -1, int numberOfDatums = 0) override;
    bool update(AR2VideoBufferT *buff0, AR2VideoBufferT *buff1, std::vector<ARTrackable *>& trackables, bool lowRes, bool doDatums = false, bool doMapper = false, int markerType = -1, int numberOfDatums = 0) override;
    bool stop() override;
    void terminate() override;
    
    ARTrackable *newTrackable(std::vector<std::string> config, int setUID = -1) override;
