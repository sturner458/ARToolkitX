...
public:
    ...
    virtual bool update(AR2VideoBufferT *buff, std::vector<ARTrackable *>& trackables, bool lowRes, bool doDatums = false, bool doMapper = false, int markerType = -1, int numberOfDatums = 0) = 0;
    virtual bool update(AR2VideoBufferT *buff0, AR2VideoBufferT *buff1, std::vector<ARTrackable *>& trackables, bool lowRes, bool doDatums = false, bool doMapper = false, int markerType = -1, int numberOfDatums = 0) = 0;
private:
