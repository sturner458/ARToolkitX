...
public:
    ...
    virtual bool update(AR2VideoBufferT *buff, std::vector<ARTrackable *>& trackables, bool doDatums = false) = 0;
    virtual bool update(AR2VideoBufferT *buff0, AR2VideoBufferT *buff1, std::vector<ARTrackable *>& trackables, bool doDatums = false) = 0;
private:
