...
bool ARTrackerNFT::update(AR2VideoBufferT *buff, std::vector<ARTrackable *>& trackables, bool lowRes, bool doDatums, bool doMapper, int markerType, int numberOfDatums)
{
...
bool ARTrackerNFT::update(AR2VideoBufferT *buff0, AR2VideoBufferT *buff1, std::vector<ARTrackable *>& trackables, bool lowRes, bool doDatums, bool doMapper, int markerType, int numberOfDatums)
{
...
ARTrackable *ARTrackerNFT::newTrackable(std::vector<std::string> config, int setUID)
{
